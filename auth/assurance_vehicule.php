...
<html>
<head>
	<title>Saisir un paiement d'assurance</title>
...
<h1>Saisir un paiement d'assurance</h1>
<br>
	<?php
	if(isset($_POST["Valider"]))
	{
		...
		$conectBDD = new BDD();
		$res = $conectBDD->Assurance_Create($id, $_POST['date'], $_POST['nom'], $_POST['montant']);

		if($res)
		{
			?>
			<div class="alert alert-success" role="alert">
			  	Le paiement d'assurance du véhicule à bien été enregistré.
			</div>
...
?>
		...
		<div class="input-group" style="text-align: center">
  			...
  			<input type="text" name="nom" style="width: 200px" class="input-text form-control" aria-describedby="basic-addon1">
  		</div>
		<br>
