...
<html>
<head>
	<title>Saisir le kilometrage d'un véhicule</title>
...
<h1>Saisir le kilometrage d'un véhicule</h1>
<br>
	<?php
	if(isset($_POST["Valider"]))
	{
		...
		$conectBDD = new BDD();
		$res = $conectBDD->Kilometrage_Create($id, $_POST['date'], $_POST['km']);

		if($res)
		{
			?>
			<div class="alert alert-success" role="alert">
			  	Le kilométrage du véhicule à bien été enregistré.
			</div>
