...
<html>
<head>
	<title>Création d'un type d'entretien</title>
...
<h1 class="title">Création d'un type d'entretien</h1>
<br>
	<?php
	if(isset($_POST["Valider"]))
	{
		...
		$res = $conectBDD->Entretien_Create($libelle);
		if($res!=false)
		{
			?>
			<div class="alert alert-success" role="alert">
			  	Le Type d'entretien a bien été crée.
			</div>
